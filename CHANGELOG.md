...
- Recompiled plugin with Go version `1.24`. ([#54](https://github.com/turbot/steampipe-plugin-updown/pull/54))
- Recompiled plugin with [steampipe-plugin-sdk v5.13.1](https://github.com/turbot/steampipe-plugin-sdk/blob/develop/CHANGELOG.md#v5131-2025-09-25) that addresses critical and high vulnerabilities in dependent packages. ([#55](https://github.com/turbot/steampipe-plugin-updown/pull/55))
